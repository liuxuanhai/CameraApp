package com.android.ippd.cameraapp.video;
/*
 * UVCCamera
...
import com.android.ippd.cameraapp.glutils.RenderHandler;
...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    private static final int VIDEO_WIDTH = 1920;//1920; //getApplicationContext().getResources().getDisplayMetrics().widthPixels;//640;
    private static final int VIDEO_HEIGHT = 1080;//480;
