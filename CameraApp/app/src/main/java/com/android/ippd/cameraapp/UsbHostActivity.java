...
public class UsbHostActivity extends Activity {
    ...
    private static final int targetVendorID= 2316;
    private static final int targetProductID = 892;
    ...
    private void connectUsb(){
        ...
        Toast.makeText(UsbHostActivity.this,
                "connectUsb()",
    ...
    private void doReadRawDescriptors(UsbDevice device){
        ...
        if(usbDeviceConnection != null){
            ...
            try {
                ...
                Toast.makeText(UsbHostActivity.this, e.toString(), Toast.LENGTH_LONG).show();
